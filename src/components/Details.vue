...
<typical
  ...
  :steps="['Hi', 1000, 'Awesome to see!', 500, 'Awesome to see you! Aha :-) 👋', 1000]"
  :loop="3"
  :wrapper="'h3'"
></typical>
...
.welcome-msg {
  ...
  letter-spacing: 4px;
  overflow: hidden;
  background: linear-gradient(90deg, rgb(233, 31, 31), rgb(243, 189, 10), rgb(253, 62, 62));
...
.typicalWrapper::after {
  content: "Please Wash Your Hands and Sanitize!!!";
